							...
							<li class="<?php echo $class; ?>">
								...
								<?php if( has_post_thumbnail() ) { ?>
									<a href="<?php the_permalink() ?>" class="headline-link headline-left">
										<?php the_post_thumbnail( 'cyberchimps-headline-thumb', array( 'class' => 'headline-thumb' ) ); ?>
									</a>
								<?php } ?>
										...
										<div class="featured-list-item">
											<div class="col-md-4">
												...
												if( has_post_thumbnail() ) {
													the_post_thumbnail( 'cyberchimps-featured-thumb', array( 'class' => 'featured-list-thumb' ) );
												}?>
											</div>
											<div class="col-md-8">
