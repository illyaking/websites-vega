	...
	class CyberChimpsPortfolio {
		...
		function cyberchimps_init_portfolio_post_type() {
			...
			$portfolio_config = array(
				...
				'fields'         => apply_filters( 'cyberchimps_portfolio_metabox_fields', $portfolio_fields), // list of meta fields (can be added by field arrays)
			...
			$page_config = array(
				...
				'context'        => 'normal', // where the meta box appear: normal (default), advanced, side; optional
				'priority'       => 'high', // order of meta box: high (default), low; optional
				'fields'         => apply_filters( 'cyberchimps_portfolio_pro_metabox_fields', $page_fields, 'portfolio_pro' ), // list of meta fields (can be added by field arrays)
				'local_images'   => false, // Use local or hosted images (meta box images for add/remove)
				'use_with_theme' => true //change path if used with theme set to true, false for a plugin or anything else for a custom path(default false).
			);
							...
							<li id="portfolio_wrap" class="<?php echo $span; ?>">
								<div class="portfolio-item">
									<a href="<?php echo $url; ?>" <?php echo $rel; ?> title="<?php echo $caption; ?>">
										...
										<div class="portfolio-caption"><?php echo apply_filters( 'cyberchimps_portfolio_caption', $caption, $port->ID ); ?></div>
									</a>
								</div>
							</li><!-- #portfolio_wrap -->
						<?php endif;
