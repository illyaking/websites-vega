	...
	class CyberChimpsSlider {
		...
		function cyberchimps_init_slides_post_type() {
			...
			$slider_config = array(
				...
				'fields' => apply_filters( 'cyberchimps_slider_custom_fields', $slider_fields, 'slider' ), // list of meta fields (can be added by field arrays)
			...
			$page_config = array(
				...
				'title'          => __( 'CyberChimps Slider Options', 'cyberchimps_elements' ), // meta box title
				'pages'          => array( 'page' ), // post types, accept custom post types as well, default is array('post'); optional
				'context'        => 'normal', // where the meta box appear: normal (default), advanced, side; optional
				'priority'       => 'high', // order of meta box: high (default), low; optional
				'fields'         => apply_filters( 'cyberchimps_slider_metabox_fields', $page_fields, 'slider' ), // list of meta fields (can be added by field arrays)
				'local_images'   => false, // Use local or hosted images (meta box images for add/remove)
				'use_with_theme' => true //change path if used with theme set to true, false for a plugin or anything else for a custom path(default false).
			);
		...
		public function render_display() {
			...
			// set out display
			?>
			<div id="slider" class="carousel slide slider-section" data-ride="carousel">
                                <ol class="carousel-indicators">
                                   <?php  $slide_counter = 0;
                                       // Setting the loop to get all slides
                                       foreach( $slider as $slide ) {?>
                                               <li class="" data-slide-to="<?php echo $slide_counter; ?>" data-target="#slider"></li>
                                       <?php $slide_counter++; } ?>
				...
				<div class="carousel-inner" role="listbox">
							...
							<div class="item <?php echo ( $slide_counter == 1 ) ? "active" : ""; ?>">
								...
								<?php if( $slide_url != "" ) { ?>
									<a href="<?php echo esc_url( $slide_url ); ?>">
										<img alt="<?php echo $title; ?>" src="<?php echo $img_src; ?>" <?php echo $height; ?> />
									</a>
								<?php
								}
								else {
								...
								if( ( $title_toggle == "1" && $title != "" ) || ( $caption_toggle == "1" && $caption != "" ) ) {
									...
									<div class="carousel-caption">
										...
										?>
                                                                                <?php 
                                                                                if(!empty($post_id)){
                                                                                     apply_filters( 'cyberchimps_slider_readmore', $post_id );
                                                                                }?>
                                                                       </div>
								<?php
								} ?>
					...
					// fallback if no slides are set
						...
						<div class="item active">
							<!-- Slide image -->
							<a href="http://cyberchimps.com"><img alt="Slider_image"
							...
							<!-- Display Caption -->
							<div class="carousel-caption">
								<h2><?php echo apply_filters( 'cyberchimps_slide_pro_caption1', 'CyberChimps' ); ?></h2>
							</div>
						</div>
						...
						<div class="item">
							...
							<!-- Display Caption -->
							<div class="carousel-caption">
								<h2><?php echo apply_filters( 'cyberchimps_slide_pro_caption2', 'CyberChimps' ); ?></h2>
							</div>
						</div>
						...
						<div class="item">
							...
							<!-- Display Caption -->
							<div class="carousel-caption">
								<h2><?php echo apply_filters( 'cyberchimps_slide_pro_caption3', 'CyberChimps' ); ?></h2>
							</div>
						</div>
