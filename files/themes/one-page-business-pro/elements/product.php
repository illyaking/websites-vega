...
if( !class_exists( 'CyberChimpsProduct' ) ) {
	class CyberChimpsProduct {
		...
		public function render_display() {
			?>
			<div class="row" id="cyberchimps_product_container">
				<div class="col-md-12 <?php echo ( $this->layout() == 'left' ) ? 'text-left' : 'text-right'; ?>" id="cyberchimps_product">
					<div class="row">
						<?php
						if( $this->layout() == 'left' ) {
							$this->text_layout();
...
//                ),
			...
			$page_config = array(
				...
				'fields'         => apply_filters( 'cyberchimps_product_metabox_fields', $page_fields, 'product' ), // list of meta fields (can be added by field arrays)
		...
		public function text_layout() {
			?>
			<div class="col-md-6" id="cyberchimps_product_text">
		...
		public function media_layout() {
			?>
			<div class="col-md-6" id="cyberchimps_product_media">
				<?php
				echo $this->get_media();
				?>
			</div>
