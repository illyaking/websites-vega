	...
	class CyberChimpsCallout {
		...
		public function render_display() {
			...
			if( empty( $callout_button ) ) {
				...
				<div id="callout_container" class="row">
					<div id="callout" class="col-md-12" style="<?php echo $custom_callout_background; ?>">
				...
				<div id="callout_container" class="row">
					<div id="callout" class="col-md-12" style="<?php echo $custom_callout_background; ?>">
						<div class="row">
							...
							<!-- col-md-9 -->
							<div id="callout_button" class="col-md-3">
								<?php
		...
		public function meta_boxes() {
			if( class_exists( 'Cyberchimps_Meta_Box' ) ) {
				...
				$config = array(
					...
					'fields'         => apply_filters( 'cyberchimps_callout_metabox_fields', $fields, 'callout' ), // list of meta fields (can be added by field arrays)
