...
function cyberchimps_customize( $wp_customize ) {
        ...
        public function render_content() {
            ...
            <script>
				jQuery(function ($) {
                    ...
                    // Script to hide show the Google Heading Font input depending on value of the Heading 1 select
					var text = $('#customize-control-font_family_h1_face select').val();
					...
					$('#customize-control-font_family_h1_face select').change(function () {
   			...
   			// Script to hide show the Google Heading Font input depending on value of the Heading 2 select
					var text = $('#customize-control-font_family_h2_face select').val();
					if (text != 'Google Fonts') {
					...
					$('#customize-control-font_family_h2_face select').change(function () {
						var text_change = $(this).val();
						if (text_change != 'Google Fonts') {
							$('#customize-control-google_font_h2').hide();
                        }
   ...
   // Script to hide show the Google Heading Font input depending on value of the Heading 3 select
					var text = $('#customize-control-font_family_h3_face select').val();
					if (text != 'Google Fonts') {
					...
					$('#customize-control-font_family_h3_face select').change(function () {
						var text_change = $(this).val();
						if (text_change != 'Google Fonts') {
							$('#customize-control-google_font_h3').hide();
                        }
			...
			// Script to hide show the Google Menu Font input depending on value of the menu select
					var text = $('#customize-control-font_family_menu select').val();
					if (text != 'Google Fonts') {
						$('#customize-control-google_font_menu').hide();
                    }
                    else {
						$('#customize-control-google_font_menu').show();
                    }
					$('#customize-control-font_family_menu select').change(function () {
						var text_change = $(this).val();
						if (text_change != 'Google Fonts') {
							$('#customize-control-google_font_menu').hide();
                        }
...
//Sticky header
    ...
    $wp_customize->add_control( 'sticky_header', array(
        'label' => __( 'Sticky Header', 'cyberchimps_core' ),
        'section' => 'cyberchimps_header_section',
...
// Back to top toggle
	$wp_customize->add_setting( 'cyberchimps_options[cc_back_to_top]', array(
        'type' => 'option',
        'sanitize_callback' => 'cyberchimps_sanitize_checkbox'
    ) );

    $wp_customize->add_control( 'cc_back_to_top', array(
        'label' => __( 'Back to top', 'cyberchimps_core' ),
        'section' => 'cyberchimps_header_section',
        'settings' => 'cyberchimps_options[cc_back_to_top]',
        'type' => 'checkbox'
    ) );
    /* --------------------------------------------------------------
	...
	'hexagon'   => $imagepath . 'social/thumbs/icons-hexagon.jpg',
        'pentagon'   => $imagepath . 'social/thumbs/icons-pentagon.jpg',
        'transparent_round'   => $imagepath . 'social/thumbs/icons-transparent-round.jpg'
            ) );
...
// Heading Color 
    ...
    $wp_customize->add_setting( 'cyberchimps_options[heading_colorpicker]', array(
        'default' => '',
        'type' => 'option',
        'sanitize_callback' => 'cyberchimps_text_sanitization'
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'heading_colorpicker', array(
        'label' => __( 'Heading Color', 'cyberchimps_core' ),
        'section' => 'cyberchimps_design_section',
        'settings' => 'cyberchimps_options[heading_colorpicker]',
    ) ) );
...
//menu text color
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'menu_text_colorpicker', array(
        'label' => __( 'Menu Text Color', 'cyberchimps_core' ),
        'section' => 'cyberchimps_design_section',
        'settings' => 'cyberchimps_options[menu_text_colorpicker]',
    ) ) );

//menu hover text color
    $wp_customize->add_setting( 'cyberchimps_options[menu_hover_text_colorpicker]', array(
        'default' => '',
        'type' => 'option',
        'sanitize_callback' => 'cyberchimps_text_sanitization'
    ) );

    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'menu_hover_text_colorpicker', array(
        'label' => __( 'Menu Text Hover Color', 'cyberchimps_core' ),
        'section' => 'cyberchimps_design_section',
        'settings' => 'cyberchimps_options[menu_hover_text_colorpicker]',
    ) ) );

//active menu text color
    $wp_customize->add_setting( 'cyberchimps_options[menu_active_text_colorpicker]', array(
        'default' => '',
        'type' => 'option',
        'sanitize_callback' => 'cyberchimps_text_sanitization'
    ) );

    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'menu_active_text_colorpicker', array(
        'label' => __( 'Menu Text Active Color', 'cyberchimps_core' ),
        'section' => 'cyberchimps_design_section',
        'settings' => 'cyberchimps_options[menu_active_text_colorpicker]',
    ) ) );
/*menu text color end */
...
// H1
    ...
    $wp_customize->add_control(new Cyberchimps_Typography_Size( $wp_customize, 'font_family_h1_size', array(
    ...
    $wp_customize->add_control( 'font_family_h1_face', array(
...
// H2
    ...
    $wp_customize->add_control( new Cyberchimps_Typography_Size( $wp_customize, 'font_family_h2_size', array(
 ...
 $wp_customize->add_setting( 'cyberchimps_options[font_family_h2][face]', array(
    ...
    $wp_customize->add_control( 'font_family_h2_face', array(
...
// H3
    ...
    $wp_customize->add_control( new Cyberchimps_Typography_Size( $wp_customize, 'font_family_h3_size', array(
 ...
 $wp_customize->add_setting( 'cyberchimps_options[font_family_h3][face]', array(
    ...
    $wp_customize->add_control( 'font_family_h3_face', array(
...
// Font family for menu
    $wp_customize->add_setting( 'cyberchimps_options[font_family_menu][face]', array(
        'default' => 'Arial',
        'type' => 'option',
        'sanitize_callback' => 'cyberchimps_text_sanitization'
    ) );

    $wp_customize->add_control( 'font_family_menu', array(
        'label' => __( 'Font Family for menu', 'cyberchimps_core' ),
        'section' => 'cyberchimps_typography_section',
        'type' => 'select',
        'settings' => 'cyberchimps_options[font_family_menu][face]',
        'choices' => apply_filters( 'cyberchimps_typography_faces', $faces )
    ) );

// Google Font family for menu
    $wp_customize->add_setting( 'cyberchimps_options[google_font_menu]', array(
        'default' => 'Arial',
        'type' => 'option',
        'sanitize_callback' => 'cyberchimps_text_sanitization'
    ) );
    ...
    $wp_customize->add_control( 'google_font_menu', array(
        'label' => __( 'Google font for menu', 'cyberchimps_core' ),
        'section' => 'cyberchimps_typography_section',
        'type' => 'text',
        'settings' => 'cyberchimps_options[google_font_menu]',
    ) );
