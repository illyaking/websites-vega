			...
			<div id="container" <?php cyberchimps_filter_container_class(); ?>>
				...
				<div id="content" <?php cyberchimps_filter_content_class(); ?>>
					...
					<article id="post-0" class="post error404 not-found">
					  ...
					  <?php else: ?>
								<?php _e( 'Oops! That page cannot be found.', 'one-page-business-pro' ); ?></h1>
					  <?php endif; ?>
						</header>
					...
					<?php else: ?>
								<p><?php _e( 'It looks like nothing was found at this location. Maybe try searching for it?', 'one-page-business-pro' ); ?></p>
							<?php endif; ?>
						</div><!-- .entry-content -->
					</article><!-- #post-0 -->
